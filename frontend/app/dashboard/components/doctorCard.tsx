      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between">
            <h3 className="text-base md:text-lg font-semibold tracking-tight text-gray-900 truncate">{doctor.name}</h3>
            <div className="text-xs md:text-sm text-gray-500">{doctor.rating ? `${doctor.rating}★` : "—"}</div>
          </div>
